...
export class AnswerComponent implements OnInit {
  ...
  startingValue = '';
  constructor(private md: MarkdownParserService, private fb: FormBuilder, private answerService: AnswerService, private activatedroute: ActivatedRoute, private service: QuestionService, private router: Router, private authService:AuthenticationService,private _snackBar: MatSnackBar) {
  }
  

  ngOnInit() {
    this.startingValue = this.getPlaceHolder();
    this.compiledMarkdown = this.compileMarkdown("");

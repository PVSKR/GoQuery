...
export class AddquestionComponent implements OnInit {
  ...
  constructor(private snackBar:MatSnackBar, private fromBuilder:FormBuilder, private router:Router, private questionserviceApi:AddquestionService,private md: MarkdownparserService, private authService:AuthenticationService) { }
